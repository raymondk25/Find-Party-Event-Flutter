...
import 'package:flutter_party_event/FindEvent.dart';
      ...
      body: Container(
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: <Widget>[
              FadeAnimation(1, Text("Find the Best Festivals and Events in Taiwan.",
                    ...
                    builder: (context, child) => Transform.scale(
                      ...
                      child: Container(
                        ...
                        child: hide == false ? Row(
                          ...
                          children: <Widget>[
                            Text("Find an event", style: TextStyle(color: Colors.white, fontSize: 17),),
